...
const Work = () => {
  return (
    <div className="work-section" id="work" style={{ height: "auto", padding: "10px 0 20px 0", textAlign: "center" }}>
      <div className="work-container section-container" style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
        <h2 style={{ marginTop: "0px", marginBottom: "10px", fontSize: "clamp(30px, 4vw, 50px)" }}>
          My <span>Work</span>
        </h2>
        <p style={{ color: "#aaa", marginBottom: "20px", fontSize: "14px", maxWidth: "500px", lineHeight: "1.6" }}>
